...
|---|-----|-------------|--------|
| 1 | [Tech Stack & Project Setup](./01-tech-stack.md) | Repo structure, tooling, dev environment, deployment notes | 🟡 Draft |
| 2 | [Database Schema](./02-database-schema.md) | Tables, relationships, migrations strategy | 🟡 Draft |
| 3 | [API Design](./03-api-design.md) | REST endpoints, request/response shapes | 🟡 Draft |
| 4 | [Core UI — Home Screen](./04-ui-home.md) | Dashboard with stats (streaks, recent workouts) and "Start Workout" entry point | 🟡 Draft |
| 5 | [Core UI — Active Workout](./05-ui-active-workout.md) | Workout timer, exercise entry, set/rep/weight logging, rest timer | 🟡 Draft |
| 6 | [Core UI — Workout Templates](./06-ui-templates.md) | Pick from previous workouts, pre-fill exercises, compare to last session's weights | 🟡 Draft |
| 7 | [Exercise Library](./07-exercise-library.md) | Searchable exercise list, categories, custom exercises | 🟡 Draft |
| 8 | [Auth & User Accounts](./08-auth.md) | Login, registration, session management (deferred until UI is solid) | 🔴 Todo |
| 9 | [Stats & Progress](./09-stats-progress.md) | PR tracking, volume over time, charts, streak logic | 🔴 Todo |
| 10 | [Future Ideas](./10-future-ideas.md) | Backlog of features to consider down the road | 🔴 Todo |
